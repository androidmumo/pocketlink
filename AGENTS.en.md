...
- Do not implement or advertise later milestones as completed. Current scope includes the P2 server and P3 provisioning/reception and signed OTA development firmware; device acceptance and audio remain pending.
