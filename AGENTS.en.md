...
- Do not implement or advertise later milestones as completed. Current scope includes the P2 server, P3 provisioning/reception and signed OTA, and P4 half-duplex intercom development firmware; physical audio quality and latency await acceptance.
