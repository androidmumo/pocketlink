...
func (a *API) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/api/v1/capabilities":
		...
		stage := "foundation"
		if a.auth != nil {
			features = []string{"admin_login", "device_pairing", "device_revocation", "rooms", "text_messages", "receipts", "device_websocket", "signed_firmware_ota", "invite_registration", "shared_rooms"}
			stage = "text"
		}
