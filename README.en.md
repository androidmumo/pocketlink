...
2026-09-11; server configuration files are authoritative after later changes.
...
The pinned digest comes from the [successful CI run](https://github.com/androidmumo/pocketlink/actions/runs/34548250044).
