English | [简体中文](AGENTS.zh_CN.md)

# PocketLink repository rules

Read this file first. Read [architecture](docs/architecture/overview.md) for scope,
[setup](docs/development/setup.md) for tools and checks, and
[operations](docs/operations/deployment.md) before deployment.
...
- Do not implement or advertise later milestones as completed. Current scope is P0/P1.
...
- Every maintained Markdown document has an English default and paired Simplified
  Chinese `.zh_CN.md`, with reciprocal links. Update both together.
- Record user-visible changes in `docs/CHANGELOG.md` and its Chinese pair.
